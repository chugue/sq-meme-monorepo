                                ...
                                >
                                    <div className="game-card-left">
                                        ...
                                        <div className="game-token-image">
                                            <img src={game.tokenImageUrl || DEFAULT_TOKEN.imageUrl} alt={game.tokenSymbol || DEFAULT_TOKEN.symbol} />
                                        </div>
                                        <span className="game-token-symbol">{game.tokenSymbol || DEFAULT_TOKEN.symbol}</span>
                                    </div>
                                    <div className="game-card-right">
                                        <div className="game-stat">
                                            <span className="stat-label">총 상금 현황</span>
                                            <span className="stat-value">
                                                {formatPrizePool(game.currentPrizePool)} {game.tokenSymbol || DEFAULT_TOKEN.symbol}
                                            </span>
                                        </div>
                                        <div className="game-stat">
