...
export type BackgroundMessage =
    ...
    | { type: "PROFILE_URL_CHANGED"; username: string; userTag: string; profileInfo: { profileImageUrl: string | null; tokenAddr: string | null; tokenSymbol: string | null; tokenImageUrl: string | null; memexWalletAddress: string | null }; currentUsername?: string | null; currentUserTag?: string | null }
